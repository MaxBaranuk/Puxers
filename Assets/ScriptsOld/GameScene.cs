...
//            if (GameSettings.Record.CurrentStyle == GameRecord.Style.Custom) ball = Resources.Load<GameObject>("Prefabs/ball");
//            if (GameSettings.Record.CurrentStyle == GameRecord.Style.Synergy) ball = Resources.Load<GameObject>("Prefabs/ballSynergy");
//
//
//
//            if (GameSettings.Record.CurrentGameType == GameRecord.GameType.TwoPlayers) {
...
//            if (GameSettings.Record.CurrentGameType == GameRecord.GameType.Single) {
