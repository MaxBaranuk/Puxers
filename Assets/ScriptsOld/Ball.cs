...
//        {
//            string styleFolder = "";
//            if (GameSettings.Record.CurrentStyle == GameRecord.Style.Custom) styleFolder = "BallsCustom";
//            if (GameSettings.Record.CurrentStyle == GameRecord.Style.Synergy) styleFolder = "BallsSynergy";
...
//            if (g == gameObject)
//            {
//                if (GameSettings.Record.CurrentGameType == GameRecord.GameType.TwoPlayers) GameScene.Instance.changePlayer();
...
//            }
//
//            if (GameSettings.Record.CurrentGameType == GameRecord.GameType.Single) manager.pointsOne += value * manager.currentCombo;
//            else {
